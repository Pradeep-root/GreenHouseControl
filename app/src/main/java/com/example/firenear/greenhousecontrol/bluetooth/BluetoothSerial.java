...
public class BluetoothSerial {
    ...
    public static final String DISCOVER_UNPAIRED = "discoverUnpaired";
    ...
    public static BluetoothSerial newInstance(){
    ...
    public boolean execute(BlueToothCallback callback, String action, String[] args, Activity activity) throws JSONException {
...
*/
          ...
          /* // enableBluetoothCallback = callbackContext;
            ...
            activity.startActivityForResult(this, intent, REQUEST_ENABLE_BLUETOOTH);*/
          ...
          //  this.deviceDiscoveredCallback = null;
            ...
            int discoverableDuration = Integer.parseInt(args[0]);
   ...
   /* @Override
    ...
    private void discoverUnpairedDevices() throws JSONException {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (BluetoothDevice.ACTION_FOUND.equals(action)) {
                    ...
                    try {
                        ...
                        Log.d("BluetoothDevices:",o.toString());
                   ...
                   // callbackContext.success(unpairedDevices);
                    callback.scannedDevices(unpairedDevices);
                    activity.unregisterReceiver(this);
                }
            }
        };

        Activity activity = BluetoothSerial.this.activity;
    ...
    private void connect(String[] args, boolean secure) throws JSONException {
...
/*
                    if (dataAvailableCallback != null) {
                     ...
                     callback.readData(buffer.toString());
